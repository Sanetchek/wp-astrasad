...
function astrasad_pagenavi( $before = '', $after = '', $echo = true, $args = array(), $wp_query = null ) {

    wp_register_style('astrasad-metabox-image-css', get_template_directory_uri() . '/css/pagination.css', array(), '', 'all' );
    ...
    $default_args = apply_filters('astrasad_pagenavi_args', $default_args ); // чтобы можно было установить свои значения по умолчанию
    ...
    $out .= $before . "<div class='navigation'>\n";
    ...
    $out = apply_filters('astrasad_pagenavi', $out );
